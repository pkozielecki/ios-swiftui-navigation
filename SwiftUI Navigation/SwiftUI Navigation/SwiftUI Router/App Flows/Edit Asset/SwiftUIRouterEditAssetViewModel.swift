...
final class SwiftUIRouterEditAssetViewModel: EditAssetViewModel {
    ...
    init(
        ...
        self.router = router
        viewState = SwiftUIRouterEditAssetViewModel.calculateViewState(
            favouriteAssetsManager: favouriteAssetsManager,
            assetId: assetId
        )
    }
...
private extension SwiftUIRouterEditAssetViewModel {
...
extension SwiftUIRouterEditAssetViewModel {
